              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#doctor"
                      ...
                      <span class="nav-text">Gestion de Doctor</span> <b class="caret"></b>
                    </a>
                   </li>
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#cobro"
                      aria-expanded="false" aria-controls="cobro">
                      <i class="mdi mdi-cash-usd"></i>
                      <span class="nav-text">Gestion de Cobros</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="cobro"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#nuevocaso"
                              aria-expanded="false" aria-controls="nuevocaso">
                                <span class="nav-text">Nuevo Caso</span><b class="caret"></b>
                              </a>
                              <ul  class="collapse"  id="nuevocaso">
                            <div class="sub-menu">
                            	<li >
                                	<a href="#">Nuevo Cobro</a>
                             	</li>
                             	<li >
                                	<a href="#">Nuevo Credito</a>
                             	</li>
                             	<li >
                                	<a href="#">Realizar abono de vale</a>
                             	</li>
                             	<li >
                                	<a href="#">Gastos de Hospitalización</a>
                             	</li>
                            </div>
                            </ul>
                            </li>
                   ...
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#paciente"
                      aria-expanded="false" aria-controls="paciente">
                      <i class="mdi mdi-hospital"></i>
                      <span class="nav-text">Gestion Pacientes</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="paciente"
                      data-parent="#sidebar-menu">
                      <div class="sub-menu">
                            <li >
                              <a class="sidenav-item-link" href="#">
                                <span class="nav-text">Nuevo Paciente</span>
                              </a>
                            </li>
                            <li >
                              <a class="sidenav-item-link" href="#">
                   ...
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#compra"
                      aria-expanded="false" aria-controls="compra">
                      <i class="mdi mdi-shopping"></i>
                      <span class="nav-text">Compra/Suministro</span> <b class="caret"></b>
                    </a>
                   </li>
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#fianza"
                      aria-expanded="false" aria-controls="fianza">
                      <i class="mdi mdi-book-open"></i>
                      <span class="nav-text">Fianzas e informes</span> <b class="caret"></b>
                    </a>
                   </li>
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#rrhh"
                      aria-expanded="false" aria-controls="rrhh">
                      <i class="mdi mdi-account-group"></i>
                      <span class="nav-text">Gestion RRHH</span> <b class="caret"></b>
                    </a>
                   </li>
                   <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#sistema"
                      aria-expanded="false" aria-controls="sistema">
                      <i class="mdi mdi-pokeball"></i>
                      <span class="nav-text">Sistema</span> <b class="caret"></b>
                    </a>
                    <ul  class="collapse"  id="paciente"
                      data-parent="#sidebar-menu">
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="#">
                                <span class="nav-text">Modificar Usuario</span>
                              </a>
                            </li>
                            <li >
                              <a class="sidenav-item-link" href="#">
